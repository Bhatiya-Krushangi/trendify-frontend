...
const inputClass =
  "border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 placeholder:text-slate-400 dark:placeholder:text-slate-500 rounded-md px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500";
...
const Contact = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto py-6">
      <h1 className="text-3xl font-display font-bold mb-3 text-slate-900 dark:text-white">{t("contact.title")}</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-[1fr_1.3fr] gap-8">
        <div className="flex flex-col gap-4">
          <div className="flex items-start gap-3 card-surface p-4">
            ...
            <div>
              <p className="font-semibold text-sm text-slate-900 dark:text-white">{t("contact.email")}</p>
          ...
          <div className="flex items-start gap-3 card-surface p-4">
            ...
            <div>
              <p className="font-semibold text-sm text-slate-900 dark:text-white">{t("contact.newsroom")}</p>
